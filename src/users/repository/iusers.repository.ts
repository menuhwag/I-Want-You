...
export interface IUserRepository {
    ...
    findAll(offset: number, limit: number): Promise<UserEntity[] | null>;
    save(username: string, email: string, password: string, nickname: string, verifyToken: string, foo: string): Promise<void>;
